...
const Review = () => {
  return (
      <div className='main' style={{ width: '85%',display:'flex',gap:"20px",margin:'auto' }}>
          <div style={{width:'365px'}}>
              <img width="100%" src={require('../Assets/images/upper.png')} alt="" />
              <Title>Review of: Mangeshi Temple</Title>
              <img width="100%" src={require('../Assets/images/dots.png')} alt="" />
          ...
          <div style={{width:'365px'}}>
              <img width="100%" src={require('../Assets/images/u2.png')} alt="" />
          ...
          <div style={{width:'365px'}}>
              <img width="100%" src={require('../Assets/images/u3.png')} alt="" />
